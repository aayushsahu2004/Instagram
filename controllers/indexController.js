...
exports.updateUserDetails = tryCatch(async function (req, res, next) {
...
exports.uploadPostPage = tryCatch(async function (req, res) {
    const user = await userModel.findOne({
        username: req.session.passport.user
    })
...
exports.searchUser = tryCatch(async function (req, res) {
    const user = await userModel.findOne({
        username: req.session.passport.user
    })
...
exports.showSearchUser = tryCatch(async function (req, res) {
    const user = await userModel.findOne({ username: req.session.passport.user })
...
exports.storyPage = tryCatch(async function (req, res) {
...
exports.nextStoryPage = tryCatch(async function (req, res) {
...
exports.userPosts = tryCatch(async function (req, res) {
...
exports.savedPosts = tryCatch(async function (req, res) {
    const user = await userModel.findOne({ username: req.session.passport.user })
...
exports.showSuggestions = tryCatch(async function (req, res) {
    const user = await userModel.findOne({
        username: req.session.passport.user
    });
...
exports.showUserProfile = tryCatch(async function (req, res) {
    const user = await userModel.findOne({ username: req.session.passport.user });
...
exports.followUser = tryCatch(async function (req, res) {
    const user = await userModel.findOne({ username: req.session.passport.user });
...
exports.showFollowers = tryCatch(async function (req, res) {
...
exports.showFollowings = tryCatch(async function (req, res) {
    const currentUser = await userModel.findOne({ username: req.session.passport.user });
    const currentUserId = currentUser._id
    const user = await userModel.findOne({ _id: req.params.userId });
...
exports.removeFollowers = tryCatch(async function (req, res) {
    const user = await userModel.findOne({ username: req.session.passport.user });
...
exports.likePost = tryCatch(async function (req, res) {
    const user = await userModel.findOne({ username: req.session.passport.user });
...
exports.doubleClickLike = tryCatch(async function (req, res) {
    const user = await userModel.findOne({ username: req.session.passport.user });
    const post = await postModel.findOne({
        _id: req.params.postId
    });
...
exports.savePost = tryCatch(async function (req, res) {
    const user = await userModel.findOne({ username: req.session.passport.user });
...
exports.createComments = tryCatch(async function (req, res) {
    const user = await userModel.findOne({ username: req.session.passport.user });
...
exports.showComments = tryCatch(async function (req, res) {
    const post = await postModel.findOne({ _id: req.params.postId });
    const comments = await commentModel.find({ post: post._id }).populate('user');
    res.json(comments);
});

exports.deletePost = tryCatch(async function (req, res) {
